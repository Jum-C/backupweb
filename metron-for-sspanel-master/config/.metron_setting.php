...
#####  主题设置  --------------------------------------------------------------------------------------------
$_MT['authcode']    = '章鱼哥的鸡巴真大';              // 主题授权码
$_MT['assets_true'] = true;                 // 目前不要动, 保持 true
$_MT['assets_bb']   = '3.0.2';                // 版本
$_MT['assets_url'] = $_MT['assets_true']?'https://cdn.jsdelivr.net/gh/xiaoyanggo/metron-assets@master'.'/metron' : '/theme/metron';
...
$_MT['domain_time']  = 1;                     // 弹出后间隔多久再提示 (单位:分钟)

$_MT['enable_pop']   = true;                      // 开启右下角重要通知弹窗
$_MT['pop_time']     = 1;                          // 每次弹出间隔多久时间 (单位:分钟)
...
<p class="text-danger font-weight-bold" font size="5" color="orange">ps：违反审计到一定的次数会被强制断网30分钟喔</p>
';
...
$_MT['take_back_total']     = 100;        // 申请转账提现需大于多少金额, 0 为不限制
$_MT['agent_menu_enable']   = true;     // 菜单显示 代理中心 (代理中心需额外 Agent 授权, 未购买无法使用);     
$_MT['take_cash_enable']    = true;    // 非代理商(邀请注册页面)允许申请现金提现, 需主题有 Agent 授权, 没有授权保持关闭, 默认有提现至钱包余额
...
# 节点订阅筛选
$_MT['nodes_filter'] = true;        // 开启订阅节点筛选
...
$_MT['shop_conversion']        = true;                      // 允许套餐折算返还余额
$_MT['shop_formalities']       = 5;                      // 套餐折算时扣除手续费 (单位: 百分比, 0 为不扣手续费) 不建议太高免得挨骂
...
$_MT['shop_pop_info']           = '
<p class="text-danger font-weight-bold"  color="red">充值不到账请到QQ群找群主处理即可</p>
<p class="text-danger font-weight-bold"  color="red">所有套餐现均支持自助折算返还到余额</p>
<p class="text-danger font-weight-bold"  color="red">所有套餐现均支持自助折算返还到余额</p>
<p class="text-danger font-weight-bold"  color="red">所有套餐现均支持自助折算返还到余额</p>
<a href="https://fakaya.me/" target=”_blank”>微信充值请点这</a> 

<p class="text-danger font-weight-bold"  color="red">微信充值请移步到卡铺（购买充值码）https://fakaya.me/</p>


';                   // 套餐顶部显示的内容 使用 html 编写

$_MT['shop_activity_true']     = true;                     //是否显示活动套餐
$_MT['shop_activity_name']     = '测试套餐请勿购买';                 //活动套餐商品名称
$_MT['shop_activity_text']     = '限时购买套餐, 过时不候';    //活动套餐商品描述
$_MT['shop_activity_id']       = 1;                         //活动套餐商品id
$_MT['shop_activity_buy_time'] = '2020/8/15 00:00:00';     //活动截止购买时间, 到时间后套餐自动隐藏
...
$_MT['client_windows'] = [
    ...
    'sstap' => array(
        ...
        'down'  => 'https://github.com/solikethis/SSTap-backup',
        'vs'    => 'v1.1.0.1',
    ),
    'ssr' => array(
        'name' => 'SSR',
        ...
        'down'  => 'https://github.com/shadowsocksrr/shadowsocksr-csharp/releases',
        'vs'  => 'v1.0',
    ),
];
...
$_MT['client_android'] = [
    'clash' => array(
        ...
        'down'  => 'https://github.com/Kr328/ClashForAndroid',
        'vs'    => 'v0.10.0',
    ),
];
